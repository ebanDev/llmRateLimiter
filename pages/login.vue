...
<template>
  <div class="min-h-screen bg-gradient-to-br from-white via-primary-50 to-primary-100/40 text-slate-900 flex items-center justify-center">
    <div class="relative w-full max-w-4xl overflow-hidden rounded-3xl border border-primary-100 bg-white shadow-2xl">
      <div class="absolute inset-0 bg-gradient-to-br from-primary-100/80 via-white/40 to-primary-100/60 pointer-events-none" />
      <div class="grid md:grid-cols-[1.1fr,0.9fr] relative">
        <div class="p-10 md:p-12 space-y-6">
          <div class="flex items-center gap-3">
            <div class="h-11 w-11 rounded-2xl bg-gradient-to-br from-primary-500 to-fuchsia-500 grid place-items-center text-white font-bold text-xl">
              ML
            </div>
            <div>
          ...
          <div class="space-y-3 text-sm text-slate-600">
            ...
            <div class="flex items-center gap-2 text-xs text-slate-500">
              <UIcon name="ph:shield-check" class="h-4 w-4 text-primary-600" />
        ...
        <div class="hidden md:block relative bg-gradient-to-br from-primary-200 to-white border-l border-primary-100">
          ...
          <div class="relative h-full p-10 flex flex-col justify-between text-slate-800">
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
              <div class="rounded-xl border border-primary-100 bg-white/60 p-3">
              ...
              <div class="rounded-xl border border-primary-100 bg-white/60 p-3 col-span-2">
                <div class="flex items-center gap-2 text-xs text-slate-600">
                  <UIcon name="ph:lock-key" class="h-4 w-4 text-primary-600" /> Token-only auth
                </div>
